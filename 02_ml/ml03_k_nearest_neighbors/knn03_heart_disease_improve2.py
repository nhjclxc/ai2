...
if __name__ == '__main__':
    ...
    X_train, X_val, y_train, y_val = model_selection.train_test_split(X_train_full, y_train_full, test_size=0.25,
                                                                      random_state=42)
    ...
    训练耗时: 0.3523 秒
    knn_score 0.9853658536585366
    (205, 3) 0.9853658536585366
    """

    print("使用网格优化\n\n")

    print(pd.DataFrame(KNN.cv_results_))  # 所有交叉验证结果
    print('KNN.best_estimator_', KNN.best_estimator_)  # 最佳模型
    print('KNN.best_score_', KNN.best_score_)  # 最佳得分
